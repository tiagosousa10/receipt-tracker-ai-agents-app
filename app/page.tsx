...
import { BarChart, Check, Search, Shield, Upload } from "lucide-react";
      ...
      <section className="py-16 md:py-24 bg-gray-50 dark:bg-gray-900 ">
        <div className="container px-4 md:px-6 mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12 max-w-5xl mx-auto">
            {/* Free tier */}
            <div className="flex flex-col p-6 bg-white border border-gray-200 rounded-sm shadow dark:border-gray-800 dark:bg-gray-950">
              <div className="space-y-2">
            ...
            <div className="relative flex flex-col p-6 bg-blue-50 border border-blue-200 rounded-lg shadow-sm dark:border-blue-900 dark:bg-blue-900/20">
